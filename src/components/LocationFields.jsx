  ...
  return (
    <>
      <div className="form-group">
        ...
        <select id="region" className="form-select" value={selectedRegionId} onChange={handleRegionChange} required>
      ...
      {selectedRegionId && (
        <div className="form-group">
          ...
          <select id="bodyPart" className="form-select" value={selectedBasicPartId} onChange={handleBasicPartChange} required>
      ...
      {selectedBasicPartId && selectedBasicPart && (
        <>
          <div className="form-group">
            <label htmlFor="side">Side:</label>
            <select id="side" className="form-select" value={side} onChange={(e) => setSide(e.target.value)} required>
          ...
          <div className="form-group">
            ...
            <select id="specificLocation" className="form-select" value={specificLocation} onChange={(e) => setSpecificLocation(e.target.value)} required>
